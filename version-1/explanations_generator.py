...
model_name = 'plm/Mistral-7B-Instruct-v0.2'
...
def generate_explanations(utterance, in_context_demonstrations, max_length=200, num_return_sequences=3):
...
explanations = generate_explanations(input_text, in_context_demonstrations)
